...
public class EvilNimbusJump : MonoBehaviour {
    private bool has_pressed_jump;
    ...
    void Update () {
        ...
        //For handling AI inputs for jump
        ...
        else if (rb.velocity.y > 0 && !press_jump)
        {
        ...
        //    Jump();
        //}
        if (press_jump && is_grounded && can_input && !GetComponent<EvilNimbusController>().crouching)
        {
            Jump();
        }
